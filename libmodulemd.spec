...
Version  : 2.2.3
Release  : 13
URL      : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.2.3/modulemd-2.2.3.tar.xz
Source0  : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.2.3/modulemd-2.2.3.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554144363
...
/usr/lib64/libmodulemd.so.1.8.6

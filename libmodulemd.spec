...
Version  : 2.9.1
Release  : 16
URL      : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.9.1/modulemd-2.9.1.tar.xz
Source0  : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.9.1/modulemd-2.9.1.tar.xz
...
%prep
%setup -q -n modulemd-2.9.1
cd %{_builddir}/modulemd-2.9.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585097932
...
cp %{_builddir}/modulemd-2.9.1/COPYING %{buildroot}/usr/share/package-licenses/libmodulemd/df8b6951986b90ed530a771fd3419725f7eaa4fb
...
/usr/lib64/libmodulemd.so.2.9.1

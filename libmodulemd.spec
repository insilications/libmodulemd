...
Version  : 1.6.1
Release  : 4
URL      : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-1.6.1/modulemd-1.6.1.tar.xz
Source0  : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-1.6.1/modulemd-1.6.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532114507
...
/usr/lib64/libmodulemd.so.1.6.1

...
Version  : 2.1.0
Release  : 10
URL      : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.1.0/modulemd-2.1.0.tar.xz
Source0  : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.1.0/modulemd-2.1.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550714068
...
/usr/lib64/libmodulemd.so.1.8.2

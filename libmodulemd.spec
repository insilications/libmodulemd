...
Version  : 2.2.0
Release  : 11
URL      : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.2.0/modulemd-2.2.0.tar.xz
Source0  : https://github.com/fedora-modularity/libmodulemd/releases/download/libmodulemd-2.2.0/modulemd-2.2.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1553633782
...
/usr/lib64/libmodulemd.so.1.8.3
